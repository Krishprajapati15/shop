...
export const getProductsController = async (req, res) => {
  try {
    ...
    return res
      .status(404)
      .json({ status: false, msessage: "failed to fetch product!", error });
  }
};
export const insertProductController = async (req, res) => {
  ...
  try {
    ...
    return res
      .status(404)
      .json({ status: false, msessage: "failed to insert product!", error });
  }
};
export const updateProductController = async (req, res) => {
  ...
  try {
    ...
    return res
      .status(404)
      .json({ status: false, msessage: "failed to update product!", error });
  }
};
export const deleteProductController = async (req, res) => {
  ...
  try {
    ...
    return res
      .status(404)
      .json({ status: false, msessage: "failed to delete product!", error });
  }
};
